...
//Construtor da classe para os detalhes do filme, puxados dos API's

FilmeDetalhes FilmeDetalhesFromJson(String str) => FilmeDetalhes.fromJson(json.decode(str));

String FilmeDetalhesToJson(FilmeDetalhes data) => json.encode(data.toJson());
...
class FilmeDetalhes {
    ...
    factory FilmeDetalhes.fromJson(Map<String, dynamic> json) => FilmeDetalhes(
        adult: json["adult"],
